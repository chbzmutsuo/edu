    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      {!isTeacher && !isPreview && !hasSubmitted && (
        <div className="space-y-8">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-6 text-gray-800">授業の満足度</h3>
          ...
          {/* 感想入力 */}
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4 text-gray-800">今日の授業の感想</h3>
            <textarea
              value={impression}
          ...
          <div className="text-center">
            <div className="mb-4">
              <div className="text-sm text-gray-600">回答済み: {Object.keys(answers).length + (satisfaction ? 1 : 0)} / 11</div>
      ...
      {!isTeacher && hasSubmitted && (
        <div className="text-center p-6 bg-green-50 rounded-lg">
          ...
          <div className="text-green-600 text-sm mt-1">お疲れさまでした！</div>
        </div>
      )}
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        満足度: {'★'.repeat(student.satisfaction)}
                        {'☆'.repeat(5 - student.satisfaction)}
                      </div>
                    </div>
                  </div>
      ...
      {isTeacher && !isPreview && (
        <div className="mt-8 p-4 bg-gray-100 rounded-lg">
          ...
          <div className="flex space-x-2">
            ...
            <Button onClick={() => (showRanking = !showRanking)}>{showRanking ? 'ランキングを隠す' : 'ランキングを表示'}</Button>
