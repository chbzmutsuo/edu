...
export function CalendarDay({day, currentMonth, hasWorkout, onDateClick, currentDate}: CalendarDayProps) {
  ...
  const isToday = formatDate(new Date()) === formatDate(new Date(currentDate.getFullYear(), currentMonth, day))
    ...
    <div className="flex items-center justify-center">
      <button
        ...
        className={cn(
          ...
          isToday && 'bg-yellow-500 text-white font-bold shadow-md hover:bg-blue-600'
        )}
