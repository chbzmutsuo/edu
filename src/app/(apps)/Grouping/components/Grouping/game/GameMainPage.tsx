...
import {GameClass, Grouping} from '@app/(apps)/Grouping/class/Grouping'
import {basePath} from '@cm/lib/methods/common'
import TeacherDisplay from '@app/(apps)/Grouping/components/Grouping/game/Teacher/TeacherDisplay'

import StudentDisplay from '@app/(apps)/Grouping/components/Grouping/game/Student/StudentDIsplay'
