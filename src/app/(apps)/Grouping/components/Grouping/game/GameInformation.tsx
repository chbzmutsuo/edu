...
import RandomSamplingSwith from '@app/(apps)/Grouping/components/Grouping/game/Teacher/RandomSamplingSwith'
import Award from '@app/(apps)/Grouping/components/Grouping/game/Award/Award'
