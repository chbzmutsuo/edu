...
import {Thead} from '@app/(apps)/Grouping/components/Grouping/game/Teacher/QuestionHandler/AnswerTable/Thead'
import {Tbody} from '@app/(apps)/Grouping/components/Grouping/game/Teacher/QuestionHandler/AnswerTable/Tbody'
