...
//   // すべてのレコードを日付順にソート
//   const allRecords = [...groupedRows, ...ungroupedRecords].sort((a, b) => {
...
//               label: '',
//               cellValue: (
//                 <Button size="sm" onClick={() => handleUngroupRecords(record.meisaiId)} disabled={isLoading}>
//                   解除
//                 </Button>
//               ),
//               cellProps: {
...
//             {
//               label: '利用年月日（自）',
//               cellValue: formatDate(record.fromDate),
//               cellProps: {
//                 className: 'bg-blue-100',
//               },
//             },
...
//             {
//               label: '利用年月日（至）',
//               cellValue: formatDate(record.toDate),
//               cellProps: {
//                 className: 'bg-blue-100',
//               },
//             },
...
//             {
//               label: '通行料金',
//               cellValue: `¥${NumHandler.WithUnit(record.fee, '円')}`,
//               cellProps: {
//                 className: 'bg-blue-100',
//               },
//             },
...
//             {
//               label: '',
//               cellValue: <Input type="checkbox" checked={!!selectedRows[record.id]} />,
//               cellProps: {
//                 className: 'bg-blue-100',
//               },
//             },
