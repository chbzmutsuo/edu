...
import {getReservationHistories, getHistoryStatistics, HistoryFilterType} from '../../actions/history-actions'
        ...
        {statistics && (
          <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {/* 変更者別集計 */}
              <div>
                <h3 className="text-sm font-medium text-gray-700 mb-2">変更者別 (上位5名)</h3>
                <div className="space-y-2">
                  {statistics.userChangeCounts?.map((item: any) => (
                    <div key={item.changedBy} className="flex justify-between items-center">
