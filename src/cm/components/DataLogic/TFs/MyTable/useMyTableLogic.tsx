...
import useMyTableParams from './useMyTableParams'
import useTrActions from './TableHandler/Tbody/useTrActions'
...
export const useMyTableLogic = (props: MyTableLogicProps) => {
  ...
  const infiniteScrollData = useMemo(() => {
    const {fetchNextPage, hasMore, isInfiniteScrollMode, setInfiniteScrollMode} = ClientProps2.HK_USE_RECORDS || {}
