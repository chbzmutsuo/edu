...
const MyFileControl = React.forwardRef((props: VariousInputProps, ref) => {
  const {col, latestFormData, ReactHookForm, Register, currentValue, extraFormState, setextraFormState} = props
