...
import {
  getRecord,
  renewOptions,
} from 'src/cm/components/DataLogic/TFs/MyForm/HookFormControl/Parts/MySelect/lib/MySelectMethods-client'
import {VariousInputProps} from 'src/cm/components/DataLogic/TFs/MyForm/HookFormControl/Parts/Control/VariousInput'

import {
  contextsType,
  MySelectContextType,
} from 'src/cm/components/DataLogic/TFs/MyForm/HookFormControl/Parts/MySelect/my-select-types'

import {OptionCreatorProps} from '@cm/types/types'

export default function useInitMySelect(props: VariousInputProps) {
